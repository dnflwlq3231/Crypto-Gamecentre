...
if (typeof web3 !== 'undefined') {
    ...
    $('#btn-reward').click(async function () {
        ...
        let ee = await contract.methods.DiceReward(userAccount).send({
            from : userAccount
        })
    })
    ...
    // 	let bb = await contract.methods.GetTokens(userAccount).send({
    // 		from : userAccount
    // 	});
    // 	console.log(bb)
    // }
    ...
    // async function ff(){
    // 	let cc = await contract.methods.Betting('100', userAccount).send({
    // 		from : userAccount
    // 	})
    // 	console.log(cc)
    // }
    ...
    // async function dd(){
    // 	let dd = await contract.methods.DiceGameStart('3').send({
    // 		from : userAccount
    // 	})
    // 	console.log(dd)
    // }
